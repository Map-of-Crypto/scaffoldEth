...
export interface OperatorInterface extends BaseContract {
  ...
  functions: {
    ...
    getAuthorizedSenders(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    getForwarder(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    getAuthorizedSenders(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    getForwarder(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    isAuthorizedSender(node: string, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getAuthorizedSenders(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    getForwarder(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    isAuthorizedSender(node: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
