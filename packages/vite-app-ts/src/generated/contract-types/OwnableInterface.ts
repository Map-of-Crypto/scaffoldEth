...
export interface OwnableInterface extends BaseContract {
  ...
  functions: {
    ...
    owner(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    transferOwnership(recipient: string, overrides?: CallOverrides): Promise<void>;
  };
  ...
  estimateGas: {
    ...
    owner(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    owner(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
