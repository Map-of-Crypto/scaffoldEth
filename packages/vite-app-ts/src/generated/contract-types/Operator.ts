...
export interface OperatorInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'acceptAuthorizedReceivers', values: [string[], string[]]): string;
  encodeFunctionData(functionFragment: 'acceptOwnableContracts', values: [string[]]): string;
  ...
  encodeFunctionData(functionFragment: 'distributeFunds', values: [string[], BigNumberish[]]): string;
  encodeFunctionData(
    functionFragment: 'fulfillOracleRequest',
    values: [BytesLike, BigNumberish, string, BytesLike, BigNumberish, BytesLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: 'getExpiryTime', values?: undefined): string;
  encodeFunctionData(functionFragment: 'isAuthorizedSender', values: [string]): string;
  ...
  encodeFunctionData(
    ...
    values: [string, BigNumberish, BytesLike, BytesLike, BigNumberish, BigNumberish, BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: 'oracleRequest',
    values: [string, BigNumberish, BytesLike, string, BytesLike, BigNumberish, BigNumberish, BytesLike]
  ): string;
  encodeFunctionData(functionFragment: 'owner', values?: undefined): string;
  encodeFunctionData(functionFragment: 'ownerForward', values: [string, BytesLike]): string;
  encodeFunctionData(functionFragment: 'ownerTransferAndCall', values: [string, BigNumberish, BytesLike]): string;
  encodeFunctionData(functionFragment: 'setAuthorizedSenders', values: [string[]]): string;
  encodeFunctionData(functionFragment: 'setAuthorizedSendersOn', values: [string[], string[]]): string;
  encodeFunctionData(functionFragment: 'transferOwnableContracts', values: [string[], string]): string;
  ...
  decodeFunctionResult(functionFragment: 'acceptAuthorizedReceivers', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'acceptOwnableContracts', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'acceptOwnership', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'cancelOracleRequest', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'cancelOracleRequestByRequester', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: 'getExpiryTime', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: 'ownerForward', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: 'setAuthorizedSendersOn', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'transferOwnableContracts', data: BytesLike): Result;
  ...
  getEvent(nameOrSignatureOrTopic: 'TargetsUpdatedAuthorizedSenders'): EventFragment;
}

export type AuthorizedSendersChangedEvent = TypedEvent<[string[], string], { senders: string[]; changedBy: string }>;

export type AuthorizedSendersChangedEventFilter = TypedEventFilter<AuthorizedSendersChangedEvent>;

export type CancelOracleRequestEvent = TypedEvent<[string], { requestId: string }>;
...
export type OracleResponseEvent = TypedEvent<[string], { requestId: string }>;

export type OracleResponseEventFilter = TypedEventFilter<OracleResponseEvent>;

export type OwnableContractAcceptedEvent = TypedEvent<[string], { acceptedContract: string }>;

export type OwnableContractAcceptedEventFilter = TypedEventFilter<OwnableContractAcceptedEvent>;
...
export type TargetsUpdatedAuthorizedSendersEvent = TypedEvent<
  ...
  { targets: string[]; senders: string[]; changedBy: string }
>;

export type TargetsUpdatedAuthorizedSendersEventFilter = TypedEventFilter<TargetsUpdatedAuthorizedSendersEvent>;
...
export interface Operator extends BaseContract {
  ...
  functions: {
    ...
    isAuthorizedSender(sender: string, overrides?: CallOverrides): Promise<[boolean]>;
  ...
  callStatic: {
    acceptAuthorizedReceivers(targets: string[], senders: string[], overrides?: CallOverrides): Promise<void>;

    acceptOwnableContracts(ownable: string[], overrides?: CallOverrides): Promise<void>;
    ...
    distributeFunds(receivers: string[], amounts: BigNumberish[], overrides?: CallOverrides): Promise<void>;
    ...
    onTokenTransfer(sender: string, amount: BigNumberish, data: BytesLike, overrides?: CallOverrides): Promise<void>;
    ...
    ownerForward(to: string, data: BytesLike, overrides?: CallOverrides): Promise<void>;

    ownerTransferAndCall(to: string, value: BigNumberish, data: BytesLike, overrides?: CallOverrides): Promise<boolean>;

    setAuthorizedSenders(senders: string[], overrides?: CallOverrides): Promise<void>;

    setAuthorizedSendersOn(targets: string[], senders: string[], overrides?: CallOverrides): Promise<void>;

    transferOwnableContracts(ownable: string[], newOwner: string, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    AuthorizedSendersChanged(senders?: null, changedBy?: null): AuthorizedSendersChangedEventFilter;

    'CancelOracleRequest(bytes32)'(requestId?: BytesLike | null): CancelOracleRequestEventFilter;
    CancelOracleRequest(requestId?: BytesLike | null): CancelOracleRequestEventFilter;
    ...
    'OracleResponse(bytes32)'(requestId?: BytesLike | null): OracleResponseEventFilter;
    OracleResponse(requestId?: BytesLike | null): OracleResponseEventFilter;

    'OwnableContractAccepted(address)'(acceptedContract?: string | null): OwnableContractAcceptedEventFilter;
    OwnableContractAccepted(acceptedContract?: string | null): OwnableContractAcceptedEventFilter;
  ...
  estimateGas: {
    ...
    isAuthorizedSender(sender: string, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getAuthorizedSenders(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    isAuthorizedSender(sender: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
