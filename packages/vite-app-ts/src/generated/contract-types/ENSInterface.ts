...
export type NewOwnerEvent = TypedEvent<[string, string, string], { node: string; label: string; owner: string }>;

export type NewOwnerEventFilter = TypedEventFilter<NewOwnerEvent>;

export type NewResolverEvent = TypedEvent<[string, string], { node: string; resolver: string }>;

export type NewResolverEventFilter = TypedEventFilter<NewResolverEvent>;

export type NewTTLEvent = TypedEvent<[string, BigNumber], { node: string; ttl: BigNumber }>;

export type NewTTLEventFilter = TypedEventFilter<NewTTLEvent>;

export type TransferEvent = TypedEvent<[string, string], { node: string; owner: string }>;
...
export interface ENSInterface extends BaseContract {
  ...
  callStatic: {
    ...
    setSubnodeOwner(node: BytesLike, label: BytesLike, owner: string, overrides?: CallOverrides): Promise<void>;
